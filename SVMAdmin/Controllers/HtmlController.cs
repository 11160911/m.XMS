...
namespace SVMAdmin.Controllers
{
    ...
    public class HtmlController : Controller
    {
        ...
        public IActionResult Menu()
        {
            ...
            PubUtility.AppendScriptAtBodyEnd(doc1, "js/echarts.min.js");
        ...
        [Route("SystemSetup/MSSA102")]
        public IActionResult MSSA102()
        {
            HtmlAgilityPack.HtmlDocument doc1 = new HtmlAgilityPack.HtmlDocument();
            string strHtml = System.IO.File.ReadAllText(ConstList.HostEnvironment.WebRootPath + @"\SystemSetup\MSSA102.html".AdjPathByOS());
            doc1.LoadHtml(strHtml);
        ...
        [Route("SystemSetup/MSSA105")]
        public IActionResult MSSA105()
        {
            HtmlAgilityPack.HtmlDocument doc1 = new HtmlAgilityPack.HtmlDocument();
            string strHtml = System.IO.File.ReadAllText(ConstList.HostEnvironment.WebRootPath + @"\SystemSetup\MSSA105.html".AdjPathByOS());
            doc1.LoadHtml(strHtml);
        ...
        [Route("SystemSetup/MSSD103")]
        public IActionResult MSSD103()
        {
            HtmlAgilityPack.HtmlDocument doc1 = new HtmlAgilityPack.HtmlDocument();
            string strHtml = System.IO.File.ReadAllText(ConstList.HostEnvironment.WebRootPath + @"\SystemSetup\MSSD103.html".AdjPathByOS());
            doc1.LoadHtml(strHtml);
        ...
        [Route("SystemSetup/MSSD107")]
        public IActionResult MSSD107()
        {
            HtmlAgilityPack.HtmlDocument doc1 = new HtmlAgilityPack.HtmlDocument();
            string strHtml = System.IO.File.ReadAllText(ConstList.HostEnvironment.WebRootPath + @"\SystemSetup\MSSD107.html".AdjPathByOS());
            doc1.LoadHtml(strHtml);
        ...
        [Route("SystemSetup/MSSA109")]
        public IActionResult MSSA109()
        {
            HtmlAgilityPack.HtmlDocument doc1 = new HtmlAgilityPack.HtmlDocument();
            string strHtml = System.IO.File.ReadAllText(ConstList.HostEnvironment.WebRootPath + @"\SystemSetup\MSSA109.html".AdjPathByOS());
            doc1.LoadHtml(strHtml);
