...
namespace SVMAdmin.Controllers
{
    ...
    public class HtmlController : Controller
    {
        ...
        [Route("SystemSetup/ISAMQPLU")]
        public IActionResult ISAMQPLU()
        {
            HtmlAgilityPack.HtmlDocument doc1 = new HtmlAgilityPack.HtmlDocument();
            string strHtml = System.IO.File.ReadAllText(ConstList.HostEnvironment.WebRootPath + @"\SystemSetup\ISAMQPLU.html".AdjPathByOS());
            doc1.LoadHtml(strHtml);
