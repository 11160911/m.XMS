var Pagetest = function (ParentNode) {
    let AllPages;
    let grdU;
    let EditMode;
    let SetSuspend = "";
    ...
    //2021-04-27
    let afterGetInittest = function (data) {
        AssignVar();
    ...
    let afterLoadPage = function () {
        //2021-04-27
        PostToWebApi({ url: "api/SystemSetup/GetInittest", success: afterGetInittest });
        $('#pgtest').show();
        $('#pgSysUsersEdit').hide();
    };

    if ($('#pgtest').length == 0) {
        //2021-04-29 Debug用，按F12後，在主控台內會顯示aaaaaatest
        console.log("aaaaaatest");
        //2021-04-27
        AllPages = new LoadAllPages(ParentNode, "test", ["pgtest"], afterLoadPage);
    };
