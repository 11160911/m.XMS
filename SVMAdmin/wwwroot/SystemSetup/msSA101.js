    ...
    let afterMSSA101Query_D = function (data) {
        ...
        if (ReturnMsg(data, 0) != "MSSA101QueryOK") {
            ...
            if (dtDelt.length == 0) {
                ...
                $('#tbQueryD thead td#Dtd1').html('');
                $('#tbQueryD thead td#Dtd2').html('');
                $('#tbQueryD thead td#Dtd3').html('');
                $('#tbQueryD thead td#Dtd4').html('');
                $('#tbQueryD thead td#Dtd5').html('');
                $('#tbQueryD thead td#Dtd6').html('');
                $('#tbQueryD thead td#Dtd7').html('');
                return;
            }
...
//#endregion
    ...
    let Step2_click = function (bt) {
        ...
        if (head.toString().indexOf("銷售日期") >= 0) {
            $('#lblD_DateTitle').html('日&emsp;&emsp;期');
        } else {
            $('#lblD_DateTitle').html('日期區間');
        }
...
//#region FormLoad
    let GetInitMSSA101 = function (data) {
        if (ReturnMsg(data, 0) != "GetInitMSSA101OK") {
            ...
            //$('#rdoS,#rdoA,#rdoD').change(function () { ClearQuery() });
