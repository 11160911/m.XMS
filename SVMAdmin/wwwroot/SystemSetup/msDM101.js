var PageMSDM101 = function (ParentNode) {
    ...
    let InitModifyDeleteButton = function () {
        $('#tbQMSDM101 .fa-trash-o').click(function () { btDelete_click(this) });
        $('#tbQMSDM101 .tdCol1').click(function () { MSDM101Query_EDM_click(this) });
    }
    ...
    let btDelete_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101ChkDelete", data: pData, success: afterMSDM101ChkDelete });
    };

    let afterMSDM101ChkDelete = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101ChkDeleteOK") {
            ...
            if (GetNodeValue(dtE[0], "ApproveDate") != "") {
                ...
                DyConfirm("請確認是否刪除DM單據(" + GetNodeValue(dtE[0], "DocNo") + ")？", function () {
                    ...
                    PostToWebApi({ url: "api/SystemSetup/MSDM101Delete", data: pData, success: afterMSDM101Delete });
                }, function () { DummyFunction();})
            }
        }
    };

    let afterMSDM101Delete = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101DeleteOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
    ...
    let btDelete_ImgUp_click = function (bt) {
        DyConfirm("請確認是否刪除此圖片？", function () {
            ...
            PostToWebApi({ url: "api/SystemSetup/MSDM101DelImg", data: pData, success: afterMSDM101DelImg });
        },function () {
            DummyFunction();
        })
    };

    let afterMSDM101DelImg = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101DelImgOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            $('#modal_ImgUp').modal('hide');
    ...
    //EDM查詢
    let MSDM101Query_EDM_click = function (bt) {
        $('#tbQMSDM101 td').closest('tr').css('background-color', 'white');

        $(bt).closest('tr').click();
        $('.msg-valid').hide();
        var node = $(grdM.ActiveRowTR()).prop('Record');
        $('#tbQMSDM101 td:contains(' + GetNodeValue(node, 'DocNo') + ')').closest('tr').css('background-color', '#DEEBF7');
        var pData = {
            DocNo: GetNodeValue(node, 'DocNo')
        }
        PostToWebApi({ url: "api/SystemSetup/MSDM101Query_EDM", data: pData, success: afterMSDM101Query_EDM });
    };

    let afterMSDM101Query_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101Query_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtH = data.getElementsByTagName('dtH');
    ...
    let btCancel_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101Query_EDM", data: pData, success: afterMSDM101Cancel_EDM });
    };

    let afterMSDM101Cancel_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101Query_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
    ...
    let btSave_EDM_click = function (bt) {
        ...
        if ($('#txtPSNO_EDM').val() == "") {
            DyAlert("請選擇小計折價單號!", function () { EnableForm_EDM(false) })
            return;
        }
        var P2 = $('#P2_EDM').attr('src');
        if (P2 == "") {
        ...
        if (window.t2.getData() == "<p>&nbsp;</p>") {
            DyAlert("請輸入優惠券內容!", function () { EnableForm_EDM(false) })
            return;
        }
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_Save_EDM", data: pData, success: afterMSDM101_Save_EDM });
    };

    let afterMSDM101_Save_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_Save_EDMOK") {
            DyAlert(ReturnMsg(data, 1), function () { EnableForm_EDM(false) });
        }
        else {
    ...
    let btApp_EDM_click = function (bt) {
        DyConfirm("確定批核此DM？", function () {
            ...
            PostToWebApi({ url: "api/SystemSetup/MSDM101Query_EDM", data: pData, success: afterMSDM101_ChkApprove_EDM });
        }, function () { DummyFunction() })
    };

    let afterMSDM101_ChkApprove_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101Query_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            ...
            if (GetNodeValue(dtH[0], "ApproveDate") != "") {
                ...
                PostToWebApi({ url: "api/SystemSetup/MSDM101_Approve_EDM", data: pData, success: afterMSDM101_Approve_EDM });
            }
        }
    };

    let afterMSDM101_Approve_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_Approve_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtH = data.getElementsByTagName('dtH');
    ...
    let btDef_EDM_click = function (bt) {
        DyConfirm("確定作廢此DM？", function () {
            ...
            PostToWebApi({ url: "api/SystemSetup/MSDM101Query_EDM", data: pData, success: afterMSDM101_ChkDefeasance_EDM });
        }, function () { DummyFunction() })
    };

    let afterMSDM101_ChkDefeasance_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101Query_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            ...
            if (GetNodeValue(dtH[0], "ApproveDate") != "") {
                if (GetNodeValue(dtH[0], "DefeasanceDate") != "") {
                    ...
                    PostToWebApi({ url: "api/SystemSetup/MSDM101_Defeasance_EDM", data: pData, success: afterMSDM101_Defeasance_EDM });
                }
            }
            else {
    ...
    let afterMSDM101_Defeasance_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_Defeasance_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtH = data.getElementsByTagName('dtH');
    ...
    let MSDM101ShowEDM = function () {
        var pData = {
            DocNo: $('#lblDocNo_EDM').html()
        }
        PostToWebApi({ url: "api/SystemSetup/MSDM101ShowEDM", data: pData, success: afterMSDM101ShowEDM });
    };

    let afterMSDM101ShowEDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101ShowEDMOK") {
            DyAlert(ReturnMsg(data, 1), function () {
    ...
    let btQuery_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101Query", data: pData, success: afterMSDM101Query });
    };

    let afterMSDM101Query = function (data) {
        CloseLoading();
       
        if (ReturnMsg(data, 0) != "MSDM101QueryOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtE = data.getElementsByTagName('dtE');
    ...
    let btActivityCode_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpActivityCode", data: pData, success: afterMSDM101_LookUpActivityCode });
    };

    let afterMSDM101_LookUpActivityCode = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpActivityCodeOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtE = data.getElementsByTagName('dtE');
    ...
    let btQLookup_ActivityCode_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpActivityCode", data: pData, success: afterMSDM101_QLookUpActivityCode });
    };

    let afterMSDM101_QLookUpActivityCode = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpActivityCodeOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
    ...
    let btShopNo_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpShopNo", data: pData, success: afterMSDM101_LookUpShopNo });
    };

    let afterMSDM101_LookUpShopNo = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpShopNoOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtE = data.getElementsByTagName('dtE');
    ...
    let btQLookup_ShopNo_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpShopNo", data: pData, success: afterMSDM101_QLookUpShopNo });
    };

    let afterMSDM101_QLookUpShopNo = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpShopNoOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
    ...
    let btShopNo_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpShopNo_EDM", data: pData, success: afterMSDM101_ShopNo_EDM });
    };

    let afterMSDM101_ShopNo_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpShopNo_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtE = data.getElementsByTagName('dtE');
    ...
    let btQLookup_ShopNo_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpShopNo_EDM", data: pData, success: afterMSDM101_LookUpShopNo_EDM });
    };

    let afterMSDM101_LookUpShopNo_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpShopNo_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
    ...
    let btPSNO_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpPSNO_EDM", data: pData, success: afterMSDM101_LookUpPSNO_EDM });
    };

    let afterMSDM101_LookUpPSNO_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpPSNO_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtE = data.getElementsByTagName('dtE');
    ...
    let btQLookup_PSNO_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM101_LookUpPSNO_EDM", data: pData, success: afterMSDM101_QLookUpPSNO_EDM });
    };

    let afterMSDM101_QLookUpPSNO_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM101_LookUpPSNO_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
    ...
    //FormLoad
    let GetInitMSDM101 = function (data) {
    ...
    let afterLoadPage = function () {
        ...
        PostToWebApi({ url: "api/SystemSetup/GetInitmsDM", data: pData, success: GetInitMSDM101 });
    };
