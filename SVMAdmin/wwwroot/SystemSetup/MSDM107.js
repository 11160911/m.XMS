var PageMSDM107 = function (ParentNode) {
    ...
    let AssignVar = function () {
        grdM = new DynGrid(
            {
                table_lement: $('#tbQMSDM107')[0],
                class_collection: ["tdColbt icon_in_td btDelete", "tdCol1", "tdCol2", "tdCol3 text-center", "tdCol4", "tdCol5", "tdCol6 text-center", "tdCol7 text-center", "tdCol8 text-center", "tdCol9 text-center"],
                fields_info: [
    ...
    let InitModifyDeleteButton = function () {
        ...
        $('#tbQMSDM107 thead tr th').mouseenter(function () {
            var fdinfo = $(this).prop('fdinfo');
            if (fdinfo.name == "DocNO") {
                var rgb = $('#tbQMSDM107 thead tr th#thead2').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead2').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "EDMMemo") {
                var rgb = $('#tbQMSDM107 thead tr th#thead3').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead3').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "EDDate") {
                var rgb = $('#tbQMSDM107 thead tr th#thead4').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead4').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "PS_Name") {
                var rgb = $('#tbQMSDM107 thead tr th#thead5').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead5').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "ActivityCode") {
                var rgb = $('#tbQMSDM107 thead tr th#thead6').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead6').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "Cnt1") {
                var rgb = $('#tbQMSDM107 thead tr th#thead7').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead7').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "Cnt2") {
                var rgb = $('#tbQMSDM107 thead tr th#thead8').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead8').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "ApproveDate") {
                var rgb = $('#tbQMSDM107 thead tr th#thead9').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead9').css('background-color', '#ffff00')
                }
            }
            else if (fdinfo.name == "DefeasanceDate") {
                var rgb = $('#tbQMSDM107 thead tr th#thead10').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead10').css('background-color', '#ffff00')
                }
            }
        });
        $('#tbQMSDM107 thead tr th').mouseleave(function () {
            var fdinfo = $(this).prop('fdinfo');
            if (fdinfo.name == "DocNO") {
                var rgb = $('#tbQMSDM107 thead tr th#thead2').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead2').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "EDMMemo") {
                var rgb = $('#tbQMSDM107 thead tr th#thead3').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead3').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "EDDate") {
                var rgb = $('#tbQMSDM107 thead tr th#thead4').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead4').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "PS_Name") {
                var rgb = $('#tbQMSDM107 thead tr th#thead5').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead5').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "ActivityCode") {
                var rgb = $('#tbQMSDM107 thead tr th#thead6').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead6').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "Cnt1") {
                var rgb = $('#tbQMSDM107 thead tr th#thead7').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead7').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "Cnt2") {
                var rgb = $('#tbQMSDM107 thead tr th#thead8').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead8').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "ApproveDate") {
                var rgb = $('#tbQMSDM107 thead tr th#thead9').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead9').css('background-color', '#ffb620')
                }
            }
            else if (fdinfo.name == "DefeasanceDate") {
                var rgb = $('#tbQMSDM107 thead tr th#thead10').css('background-color')
                var hexcolor = SetRgbTo16(rgb);
                if (hexcolor != '#ffeaa7') {
                    $('#tbQMSDM107 thead tr th#thead10').css('background-color', '#ffb620')
                }
            }
        });
        $('#tbQMSDM107 thead tr th').click(function () {
            $('#tbQMSDM107 thead tr th').css('background-color', '#ffb620')
            var fdinfo = $(this).prop('fdinfo');
            if (fdinfo.name == "DocNO") {
                $('#tbQMSDM107 thead tr th#thead2').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "EDMMemo") {
                $('#tbQMSDM107 thead tr th#thead3').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "EDDate") {
                $('#tbQMSDM107 thead tr th#thead4').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "PS_Name") {
                $('#tbQMSDM107 thead tr th#thead5').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "ActivityCode") {
                $('#tbQMSDM107 thead tr th#thead6').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "Cnt1") {
                $('#tbQMSDM107 thead tr th#thead7').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "Cnt2") {
                $('#tbQMSDM107 thead tr th#thead8').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "ApproveDate") {
                $('#tbQMSDM107 thead tr th#thead9').css('background-color', '#ffeaa7')
            }
            else if (fdinfo.name == "DefeasanceDate") {
                $('#tbQMSDM107 thead tr th#thead10').css('background-color', '#ffeaa7')
            }
        });
    }
    ...
    let btDelete_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM104ChkDelete", data: pData, success: afterMSDM107ChkDelete });
    };

    let afterMSDM107ChkDelete = function (data) {
        if (ReturnMsg(data, 0) != "MSDM104ChkDeleteOK") {
            ...
            if (GetNodeValue(dtE[0], "ApproveDate") != "") {
                ...
                DyConfirm("請確認是否刪除DM單據(" + GetNodeValue(dtE[0], "DocNo") + ")？", function () {
                    ...
                    PostToWebApi({ url: "api/SystemSetup/MSDMDelete", data: pData, success: afterMSDM107Delete });
                }, function () { DummyFunction();})
            }
        }
    };

    let afterMSDM107Delete = function (data) {
    ...
    let MSDM107Query_EDM_click = function (bt) {
        ...
        $('.msg-valid').hide();
        var node = $(grdM.ActiveRowTR()).prop('Record');
        $('#tbQMSDM107 td:contains(' + GetNodeValue(node, 'DocNo') + ')').closest('tr').css('background-color', '#DEEBF7');
        var pData = {
            DocNo: GetNodeValue(node, 'DocNo')
        }
        PostToWebApi({ url: "api/SystemSetup/MSDMQuery_EDM", data: pData, success: afterMSDM107Query_EDM });
    };

    let afterMSDM107Query_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDMQuery_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtH = data.getElementsByTagName('dtH');
    ...
    let btCancel_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM107Cancel_EDM", data: pData, success: afterMSDM107Cancel_EDM });
    };

    let afterMSDM107Cancel_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM107Cancel_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            cs_EditMode = "Q"
    ...
    let btSave_EDM_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDM107_Save_EDM", data: pData, success: afterMSDM107_Save_EDM });
    };

    let afterMSDM107_Save_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDM107_Save_EDMOK") {
            DyAlert(ReturnMsg(data, 1), function () {
                EnableForm_EDM(false)
                $('#btSave_EDM').prop('disabled', false);
            });
    ...
    let btApp_EDM_click = function (bt) {
        ...
        DyConfirm("確定批核此DM？", function () {
            ...
            PostToWebApi({ url: "api/SystemSetup/MSDMQuery_EDM", data: pData, success: afterChkApprove_EDM });
        }, function () { DummyFunction() })
    };
    ...
    let afterChkApprove_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDMQuery_EDMOK") {
            ...
            if (GetNodeValue(dtH[0], "ApproveDate") != "") {
                ...
                PostToWebApi({ url: "api/SystemSetup/MSDMApprove_EDM", data: pData, success: afterMSDMApprove_EDM });
            }
        }
    };

    let afterMSDMApprove_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDMApprove_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtH = data.getElementsByTagName('dtH');
    ...
    let btDef_EDM_click = function (bt) {
        ...
        DyConfirm("確定作廢此DM？", function () {
            ...
            PostToWebApi({ url: "api/SystemSetup/MSDMQuery_EDM", data: pData, success: afterChkDefeasance_EDM });
        }, function () { DummyFunction() })
    };
        ...
        if (ReturnMsg(data, 0) != "MSDMQuery_EDMOK") {
            ...
            if (GetNodeValue(dtH[0], "ApproveDate") != "") {
                if (GetNodeValue(dtH[0], "DefeasanceDate") != "") {
                    ...
                    PostToWebApi({ url: "api/SystemSetup/MSDMDefeasance_EDM", data: pData, success: afterMSDMDefeasance_EDM });
                }
            }
            else {
    ...
    let afterMSDMDefeasance_EDM = function (data) {
        if (ReturnMsg(data, 0) != "MSDMDefeasance_EDMOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtH = data.getElementsByTagName('dtH');
    ...
    let btQuery_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDMQuery", data: pData, success: afterMSDMQuery });
    };

    let afterMSDMQuery = function (data) {
        CloseLoading();
       
        if (ReturnMsg(data, 0) != "MSDMQueryOK") {
    ...
    let btActivityCode_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDMLookUpActivityCode", data: pData, success: afterMSDMLookUpActivityCode });
    };
    ...
    let btQLookup_ActivityCode_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSDMLookUpActivityCode", data: pData, success: afterQMSDMLookUpActivityCode });
    };
    ...
    let afterLoadPage = function () {
        ...
        PostToWebApi({ url: "api/SystemSetup/GetInitmsDM", data: pData, success: GetInitMSDM107 });
    };

    if ($('#pgMSDM107').length == 0) {  
        AllPages = new LoadAllPages(ParentNode, "SystemSetup/MSDM107", ["MSDM107btns", "pgMSDM107Init", "pgMSDM107Add", "pgMSDM107Mod"], afterLoadPage);
    };
