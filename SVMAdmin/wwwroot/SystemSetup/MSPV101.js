var PageMSPV101 = function (ParentNode) {
    ...
    let InitModifyDeleteButton = function () {
        $('#tbQMSPV101 tbody tr td').click(function () { DMMod_click(this) });
    }
...
/////////////////////////////////////////////////
    ...
    let btQuery_click = function (bt) {
        ...
        PostToWebApi({ url: "api/SystemSetup/MSPV101Query", data: pData, success: afterMSPV101Query });
    };

    let afterMSPV101Query = function (data) {
        CloseLoading();
        if (ReturnMsg(data, 0) != "MSPV101QueryOK") {
            DyAlert(ReturnMsg(data, 1));
        }
        else {
            var dtE = data.getElementsByTagName('dtE');
