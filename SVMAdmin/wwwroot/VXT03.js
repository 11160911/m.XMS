var PageVXT03 = function (ParentNode) {
    let AllPages;
    let grdU;
    let EditMode;
    let SetSuspend = "";
    ...
    let btDisplay_click = function (bt) {
        ...
        $(bt).closest('tr').click();
        $('.msg-valid').hide();
        $('#modal_VXT03 .modal-title').text('智販機監控查詢');
    ...
    let SearchVXT03 = function () {
        ...
        PostToWebApi({ url: "api/SystemSetup/SearchVXT03", data: pData, success: AfterSearchVXT03 });
    };
    ...
    let AfterSearchVXT03 = function (data) {
    ...
    //2021-05-18
    let afterGetInitVXT03 = function (data) {

        //alert("afterGetInitVXT03");

        AssignVar();
        $('#btQueryVXT03').click(function () { SearchVXT03(); });
    ...
    let afterLoadPage = function () {
        ...
        //alert("afterLoadPage");
        //2021-04-27
        PostToWebApi({ url: "api/SystemSetup/GetInitVXT03", success: afterGetInitVXT03 });
        //alert("PostToWebApi  api/SystemSetup/GetInitVXT03");
    ...
    if ($('#pgVXT03').length == 0) {
        AllPages = new LoadAllPages(ParentNode, "VXT03", ["pgVXT03"], afterLoadPage);
    };
